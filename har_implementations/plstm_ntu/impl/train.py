...
from .utils import classes, video_pose_3d_kpts, get_batch2, get_batch


def train(epoch_nb=2000, batch_size=64, hidden_size=128, dataset_path='../../datasets/berkeley_mhad/3d', print_every=25,
    ...
    st_lstm_model = PLSTMModel(input_size, hidden_size, batch_size, len(classes), parts).to(device)
