...
from ...utils.dataset_util import DatasetInputType, normalise_skeleton_3d_batch, normalise_skeleton_3d, random_rotate_y
...
def evaluate_tests(classes, test_data, test_labels, st_lstm_model, analysed_kpts_description, input_type=DatasetInputType.SPLIT, split=20,
                   steps=32, show_diagram=True, results_path='results', use_normalization=True, add_random_rotation_y=False):
