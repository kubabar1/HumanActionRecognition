...
def train(classes, training_data, training_labels, validation_data, validation_labels, analysed_kpts_description,
    ...
    train_data_loader = HierarchicalRNNDataset(training_data, training_labels, batch_size)
    validation_data_loader = HierarchicalRNNDataset(validation_data, validation_labels, batch_size)
    ...
    for epoch in range(epoch_nb):
        ...
        if epoch % test_every == 0 and epoch > 0:
            ...
            with torch.no_grad():
                ...
                left_arms_test = data_val[0]
                right_arms_test = data_val[1]
                left_legs_test = data_val[2]
                right_legs_test = data_val[3]
    ...
    if save_model:
        save_model_common(hierarchical_rnn_model, optimizer, epoch, test_every, all_train_losses, all_test_losses,
