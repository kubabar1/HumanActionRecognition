...
from har.impl.hierarchical_rnn.evaluate import evaluate_tests, load_model, fit
...
class TestHRNN(unittest.TestCase):
    ...
    def test_run_training_evaluate_fit(self):
        generated_model_name = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized.pth'
        generated_acc_diagram = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized_acc.png'
        generated_loss_diagram = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized_loss.png'
        generated_train_acc = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized_train_acc.npy'
        generated_train_loss = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized_train_loss.npy'
        generated_val_acc = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized_val_acc.npy'
        generated_val_loss = 'model_hierarchical_rnn_en_5_bs_128_lr_0.0001_op_RMSPROP_hs_128_it_SPLIT_momentum_0.9_wd_0_split_20_steps_32_3D_normalized_val_loss.npy'
        ...
        h_rnn_model = run_load_model_test(os.path.join(self.test_results_path, generated_model_name))

        run_evaluation_test(h_rnn_model, test_data, test_labels, self.test_results_path, print_results=True)

        run_fit_test(h_rnn_model, test_data, test_labels, print_results=True)
...
def run_train_test(training_data, training_labels, validation_data, validation_labels, test_results_path):
    train(berkeley_mhad_classes, training_data, training_labels, validation_data, validation_labels, video_pose_3d_kpts, epoch_nb=5,
          show_diagram=False, results_path=test_results_path, val_every=2, print_every=2, print_results=False, add_timestamp=False)
...
def run_evaluation_test(h_rnn_model, test_data, test_labels, results_path, print_results=False):
    accuracy = evaluate_tests(berkeley_mhad_classes, test_data, test_labels, h_rnn_model, video_pose_3d_kpts,
                              results_path=results_path, show_diagram=False)
    if print_results:
        print('Test accuracy: {}'.format(accuracy))


def run_fit_test(h_rnn_model, test_data, test_labels, print_results=False):
    random_id = randrange(len(test_labels))
    test_sequence, test_label = test_data[random_id], test_labels[random_id]
    predicted = fit(berkeley_mhad_classes, test_sequence, h_rnn_model, video_pose_3d_kpts)
    if print_results:
