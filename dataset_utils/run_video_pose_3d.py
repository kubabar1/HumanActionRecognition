...
def process_custom_2d_to_3d(keypoints_npz_path, video_pose_path, viz_video, viz_subject, viz_action, viz_output='output.mp4',
                            viz_export='output.npz'):
    ...
    cameras_valid, poses_valid, poses_valid_2d = fetch(subjects_test, keypoints, dataset, action_filter)
